...
const FALLBACK: BuiltProjectRow[] = [
  {
    ...
    status: 'Live', url: 'https://replit.com/@mujeeb', image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d?w=900&q=80', highlight: true, sortOrder: 0, createdAt: new Date(), updatedAt: new Date(),
  },
  {
    ...
    status: 'Live', url: 'https://replit.com/@mujeeb', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=900&q=80', highlight: false, sortOrder: 1, createdAt: new Date(), updatedAt: new Date(),
  },
  {
    ...
    status: 'Live', url: 'https://replit.com/@mujeeb', image: 'https://images.unsplash.com/photo-1512486130939-2c4f79935e4f?w=900&q=80', highlight: false, sortOrder: 2, createdAt: new Date(), updatedAt: new Date(),
  },
  {
