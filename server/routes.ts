...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // OG image compatibility shim — index.html hard-codes /uploads/og-image.jpg
  // but the file now lives in App Storage. This route reads og.imageUrl from the
  // DB and streams the actual file so social crawlers (LinkedIn, Twitter, etc.)
  // always get the live image without any HTML change.
  app.get("/uploads/og-image.jpg", async (_req, res) => {
    try {
